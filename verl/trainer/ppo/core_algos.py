...
def compute_policy_loss(
    ...
    raw_pg_loss = verl_F.masked_mean(pg_losses1, response_mask)
    raw_pg_loss = agg_loss(loss_mat=raw_pg_loss, loss_mask=response_mask, loss_agg_mode=loss_agg_mode)

    return pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower, raw_pg_loss
